 ...
 *
 * user_profileController - Funtions for the users profile page.
 * Pass change. Edit profile pic, choose favorite sports, etc.
 */
...
angular.module('dashboard.controllers').controller('user_profileController', ['$scope', '$timeout', '$rootScope', '$http', '$routeParams', function ($scope, $timeout, $rootScope, $http, $routeParams) {
    ...
    /* Toggle between edit view and regular view */
    ...
    $scope.setDifficulty = function (skill) {
        ...
        $http({
            ...
            $http.get("/api/user_has_sport/" + data).success(function (data) {
                data.skill = skill;
                $http.put("/api/user_has_sport/" + data.id, data).success(function (item) {
                })
            });
        })
    };
    ...
    $scope.deleteSport = function (item) {
        ...
        $http({
            ...
            $http.delete("/api/user_has_sport/" + data).success(function (data) {
